...
import myapp.service.My1Service;
...
public class My1Controller {
  ...
  @GetMapping(value = "/welcome", produces = "application/My1-v1.0+json")
  ...
  @GetMapping(value = "/items", produces = "application/My1-v1.0+json")
  ...
  @PostMapping(value = "/save-item", produces = "application/My1-v1.0+json")
  ...
  @DeleteMapping(value = "/delete-item", produces = "application/My1-v1.0+json")
  ...
  @PutMapping(value = "/update-item", produces = "application/My1-v1.0+json")
